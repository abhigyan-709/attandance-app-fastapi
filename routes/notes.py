...
async def upload_pdf(
    ...
    """Uploads a PDF to S3 using streaming and saves metadata in MongoDB"""

    if current_user.role != "admin":
        raise HTTPException(
            status_code=403, detail="You do not have permission to add a Notes"
        )
    ...
    try:
        # Stream file upload directly to S3
